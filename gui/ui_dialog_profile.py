...
class Ui_ProfileDialog(object):
    ...
    def retranslateUi(self, ProfileDialog):
        ...
        self.label_6.setWhatsThis(_translate("ProfileDialog", "Environments that will wrap the questions."))
        self.label_6.setText(_translate("ProfileDialog", "Question environments:"))
        self.listwidget_envs.setWhatsThis(_translate("ProfileDialog", "Environments that will wrap the questions."))
        self.label_7.setWhatsThis(_translate("ProfileDialog", "Latex packages required to compile the question."))
        self.label_7.setText(_translate("ProfileDialog", "Required packages:"))
        self.listwidget_pckg_required.setWhatsThis(_translate("ProfileDialog", "Latex packages required to compile the question."))
